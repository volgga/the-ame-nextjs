...
const YANDEX_MAP_SRC =
  "https://yandex.ru/map-widget/v1/?z=16&ol=biz&oid=77269998905";

const LINK_CLASS =
  "text-neutral-700 hover:text-black hover:underline underline-offset-2 transition-colors";

const SECTION_TITLE_CLASS =
  "text-sm font-medium uppercase tracking-wide text-neutral-700";
      ...
      <div className="container mx-auto px-4 pt-12 pb-10">
        <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-2 lg:items-stretch">
          ...
          <div className="order-1 lg:order-2">
            <h1 className="mb-8 text-3xl font-semibold tracking-tight text-black sm:text-4xl">
              КОНТАКТЫ THE ÁME
            </h1>
