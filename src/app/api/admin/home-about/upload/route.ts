...
const BUCKET = "home-collections"; // Используем тот же bucket, что и для коллекций
...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      ...
      console.error("[admin/home-about/upload] Ошибка парсинга FormData:", e);
    ...
    if (error) {
      console.error("[admin/home-about/upload]", error);
    ...
    console.error("[admin/home-about/upload POST]", e);
