...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      ...
      console.error("[admin/products/upload] Ошибка парсинга FormData:", e);
    ...
    // Годовой кэш: изображения товаров меняются редко, immutable для максимальной производительности
