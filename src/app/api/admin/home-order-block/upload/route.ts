...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      ...
      console.error("[admin/home-order-block/upload] Ошибка парсинга FormData:", e);
    ...
    if (error) {
      console.error("[admin/home-order-block/upload]", error);
    ...
    console.error("[admin/home-order-block/upload POST]", e);
