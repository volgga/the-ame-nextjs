      ...
      <article className="container mx-auto px-4 py-10 md:py-12 max-w-full">
        ...
        <section className="mb-8 md:mb-10">
          ...
          <div className="space-y-4 text-base md:text-lg text-[#000] leading-relaxed">
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3">
              ...
              <li>направив запрос на e-mail: <a href="mailto:theame123@mail.ru" className="text-color-text-main underline hover:no-underline">theame123@mail.ru</a></li>
        ...
        <section className="mb-8 md:mb-10">
          ...
          <div className="space-y-4 text-base md:text-lg text-[#000] leading-relaxed">
            ...
            <p>Сообщения Пользователя в WhatsApp / Telegram / MAX считаются предоставлением согласия в письменной форме.</p>
          </div>
        </section>
        ...
        <section className="mb-8 md:mb-10">
          ...
          <p className="text-base md:text-lg text-[#000] leading-relaxed">
            ...
            <Link href="https://theame.ru/privacy-policy" className="text-color-text-main underline hover:no-underline" target="_blank" rel="noopener noreferrer">
