...
function DividerVertical() {
  return (
    <span
      className="h-4 w-px md:h-5 md:w-px shrink-0 ml-3 mr-1.5"
      style={{ backgroundColor: "rgba(31,42,31,0.65)" }}
      aria-hidden
    />
  );
}
...
export function TopBar() {
  return (
    ...
    >
      {/* Контейнер с теми же отступами что и во второй строке */}
      <div className="w-full flex items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-0 shrink-0">
          <a
            ...
            className="text-sm md:text-base font-normal text-header-foreground whitespace-nowrap mr-1"
          >
            +7 993 932-60-95
          </a>
          <DividerVertical />
